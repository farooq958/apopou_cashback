...
class AllFeaturesDetailScreen extends StatefulWidget {
  final int id;
  final int index;
  final bool guest;
  ...
  @override
  State<AllFeaturesDetailScreen> createState() =>
      _AllFeaturesDetailScreenState();
}

class _AllFeaturesDetailScreenState extends State<AllFeaturesDetailScreen> {
  var couponImage;
  var couponCashBack;
  var freeShipping;
                                          ...
                                          children: [
                                            ...
                                            Positioned(
                                              ...
                                              child: FeaturedHeart(
                                                index: widget.index,
                                                check:"fromout",
                                                guest: widget.guest, controller: SharePrefs.refreshController,
                                              ),
                                              // widget.isAllProduct ==
                                              //         false
                                              //     ? Align(
